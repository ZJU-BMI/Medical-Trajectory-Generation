...
if __name__ == '__main__':
    test_test('AED_—sepsis_test_DTW.txt')
    ...
    for i in range(50):
        mse, mae, r_value, p_value\
            = train(hidden_size=128,
                    learning_rate=0.00013052534616429681,
                    l2_regularization=1.0756313345023907e-05)
        # mse, mae, r_value, p_value, r_value_spearman, r_value_kendalltau\
        #     = train(hidden_size=64,
        #             learning_rate=0.0015576418547285878,
