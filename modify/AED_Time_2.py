...
if __name__ == '__main__':
    test_test('AED_Time_2_sepsis_3_22_DTW.txt')
    ...
    for i in range(50):
        ...
        #      train(hidden_size=32,
        #            learning_rate=0.0033844968861700036,
        #            l2_regularization=1.0135796282109566e-05)
        mse_all.append(mse)
        r_value_all.append(r_value)
        p_value_all.append(p_value)
        # r_value_spearman_all.append(r_value_spearman)
        # r_value_kendall_all.append(r_value_kendalltau)
        mae_all.append(mae)
