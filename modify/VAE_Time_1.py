...
if __name__ == '__main__':
    test_test('VAE_Time_1_sepsis_重新训练_test_DTW.txt')
    ...
    for i in range(50):
        mse, mae, r_value = \
            train(hidden_size=32,
                  learning_rate=9.451091104648612e-05,
                  l2_regularization=9.645276777578469e-05,
                  z_dims=32,
                  kl_imbalance=4.913507146906293e-06,
                  generated_mse_imbalance=0.09245035104288778,
                  reconstruction_imbalance=1.2470070537811577)
        mse_all.append(mse)
