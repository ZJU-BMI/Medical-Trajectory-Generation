...
class Decoder(Model):
    ...
    def call(self, input_x):
        ...
        decode_input = tf.concat((z_i_1, h_i, x_i), axis=1)
...
class Prior(Model):
    def __init__(self, z_dims):
        ...
        self.dense3 = tf.keras.layers.Dense(z_dims)  # obtain z hidden
    ...
    while train_set.epoch_completed < epochs:
        ...
        with tf.GradientTape() as tape:
            ...
            for predicted_visit_ in range(predicted_visit):
                ...
                generated_next_visit, decode_c_generate, decode_h_generate = decoder_share([z_prior, context_state, sequence_time_last_time, decode_c_generate, decode_h_generate*condition_intensity])
                ...
                construct_next_visit, decode_c_reconstruct, decode_h_reconstruct = decoder_share([z_post, context_state, sequence_time_last_time, decode_c_reconstruct, decode_h_reconstruct*condition_intensity])
...
if __name__ == '__main__':
    test_test('VAE_Hawkes_sepsis_test_DTW_test_4_16.txt')
    ...
    #                               z_dims=32,
    #                               kl_imbalance=0.01919733136747093,
    #                               generated_mse_imbalance=10.0,
    #                               reconstruction_imbalance=10.0,
    #                               likelihood_imbalance=10**(-3.3172538670507237))
    #     mse_all.append(mse)
