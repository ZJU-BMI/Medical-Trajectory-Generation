...
if __name__ == '__main__':
    test_test('VAE_Time_2_HF_test_1_4_7_26.txt')
    ...
    for i in range(50):
        mse, mae, r_value = train(hidden_size=64,
                                  learning_rate=0.029213991869359808,
                                  l2_regularization=6.217949747868166e-5,
                                  z_dims=64,
                                  kl_imbalance=1.0624368688378186e-6,
                                  generated_mse_imbalance=0.0719585968457655,
                                  reconstruction_imbalance=0.3570598188149605)
        mse_all.append(mse)
