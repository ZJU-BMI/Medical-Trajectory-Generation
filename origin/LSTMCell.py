...
def _generate_zero_filled_state_for_cell(cell, inputs_x, batch_size, dtype):
...
class LSTMCell(Layer):
    ...
    def call(self, inputs_x, states, training=None):
    ...
    def get_initial_state(self, inputs_x=None, batch_size=None, dtype=None):
        return list(_generate_zero_filled_state_for_cell(
            self, inputs_x, batch_size, dtype))