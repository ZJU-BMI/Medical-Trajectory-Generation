...
if __name__ == '__main__':
    test_test('VAE_Time_3_HF_test_3_3.txt')
    ...
    for i in range(50):
        mse, mae, r_value = train(hidden_size=64,
                                  learning_rate=0.023895989438716164,
                                  l2_regularization=2.1078482758772286e-5,
                                  z_dims=32,
                                  kl_imbalance=0.006917065376610421,
                                  generated_mse_imbalance=0.003361941824660094,
                                  reconstruction_imbalance=0.04408754820605055)
        mse_all.append(mse)
