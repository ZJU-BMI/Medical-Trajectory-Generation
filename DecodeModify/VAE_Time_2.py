...
class Decoder(Model):
    ...
    def call(self, input_x):
        input_decode, decode_c, decode_h, input_t = input_x
    ...
    while train_set.epoch_completed < epochs:
        ...
        with tf.GradientTape() as tape:
            ...
            for predicted_visit_ in range(predicted_visit):
                ...
                construct_next_visit, decode_c_reconstruct, decode_h_reconstruct = decode_share([z_post, decode_c_reconstruct, decode_h_reconstruct, input_t])
                ...
                generated_next_visit, decode_c_generate, decode_h_generate = decode_share([z_prior, decode_c_generate, decode_h_generate, input_t])
            ...
            if train_set.epoch_completed % 1 == 0 and train_set.epoch_completed not in logged:
                ...
                for predicted_visit_ in range(predicted_visit):
                    ...
                    sequence_last_time_test, decode_c_generate_test, decode_h_generate_test = decode_share([z_prior_test, decode_c_generate_test, decode_h_generate_test, input_t])
...
if __name__ == '__main__':
    test_test('VAE_Time_2_HF_train_3_3.txt')
    ...
    #                               learning_rate=0.0007924014560799575,
    #                               l2_regularization=6.456291104463124e-5,
    #                               z_dims=64,
    #                               kl_imbalance=0.0002313865469881817,
    #                               generated_mse_imbalance=5.289422406174797e-5,
    #                               reconstruction_imbalance=0.4432326285858402)
    #     mse_all.append(mse)
