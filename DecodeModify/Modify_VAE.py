...
class Post(Model):
    def __init__(self, z_dims):
        ...
        self.dense1 = tf.keras.layers.Dense(z_dims)
        self.dense2 = tf.keras.layers.Dense(z_dims)
        self.dense3 = tf.keras.layers.Dense(z_dims, activation=tf.nn.sigmoid)
    ...
    while train_set.epoch_completed < epochs:
        ...
        with tf.GradientTape() as tape:
            ...
            for predicted_visit_ in range(predicted_visit):
                ...
                construct_next_visit, decode_c_reconstruct, decode_h_reconstruct = decode_share([z_post, decode_c_reconstruct, decode_h_reconstruct])
                ...
                generated_next_visit, decode_c_generate, decode_h_generate = decode_share([z_prior, decode_c_generate, decode_h_generate])
            ...
            if train_set.epoch_completed % 1 == 0 and train_set.epoch_completed not in logged:
                ...
                for predicted_visit_ in range(predicted_visit):
                    ...
                    sequence_last_time_test, decode_c_generate_test, decode_h_generate_test = decode_share([z_prior_test, decode_c_generate_test, decode_h_generate_test])
...
if __name__ == '__main__':
    test_test('VAE_sigmoid_HF_test__3_3_修改VAE_解码器_7_24.txt')
    ...
    for i in range(50):
        mse, mae, r_value = train(hidden_size=128,
                                  learning_rate=0.003710683490658811,
                                  l2_regularization=0.00024455800134038936,
                                  z_dims=64,
                                  kl_imbalance=0.00031800480857724746,
                                  generated_mse_imbalance=2.1930100597356134e-5,
                                  reconstruction_imbalance=1.6586697311253706)
        mse_all.append(mse)
